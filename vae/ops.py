...
def conv2d(x, inputFeatures, outputFeatures,ker_size,stride, name):
    with tf.variable_scope(name):
        w = tf.get_variable("w",[ker_size,ker_size,inputFeatures, outputFeatures], initializer=tf.truncated_normal_initializer(stddev=0.02))
